                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control professions" id="profession_id" style="width: 100%;">
                                    ...
                                    <option value="{{ $profession->id }}" @if($user->profession_id == $profession->id)
                                        selected @endif>{{ $profession->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="female" name="gender"
                                        @if($user->profession_id == 'F') checked @endif>
