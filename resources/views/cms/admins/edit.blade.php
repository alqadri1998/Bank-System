                    ...
                    <form role="form" id="create_form">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $admin->first_name }}" id="first_name"
                                    placeholder="Enter name">
                            </div>
                            <div class="form-group">
                                <label for="last_name">Last Name</label>
                                <input type="text" class="form-control" value="{{ $admin->last_name }}" id="last_name"
                                    placeholder="Enter name">
                            </div>
                            <div class="form-group">
...
<script>
    function performUpdate(id){
        ...
        let redirectUrl = '{{ route('admins.index') }}'
